    ...
    <div class="flex flex-col">
        <contentCard class="mt-2 mb-4">
                ...
                <template v-slot:content>
                    <div class="flex grid grid-cols-1 md:grid-cols-3 items-center pt-4
justify-center"> 
                        <div class="items-center my-2">
                             <div class="font-sans text-sm font-thin tracking-wide textteal-
                            700 text-center">
                                BEANS WEIGHT <br/>
                                BEFORE ROAST (KG)
                         </div>
                             <div class="font-sans font-medium text-3xl tracking-wide textteal-
                            600 text-center">
                    ...
                    <div class="items-center my-2 ">
                        <div class="font-sans text-sm font-thin tracking-wide text-teal-
                        700 text-center">
                                BEANS WEIGHT <br/>
                                AFTER ROAST (KG)
                    </div>
                    ...
                    <div class="items-center my-2">
                           ...
                           700 text-center">
                            ...
                            <div class="font-sans text-sm font-medium text-3xl tracking-wide 
                         -teal-600 text-center">
                    ...
                    <div class="items-center my-2">
                        <div class="font-sans text-sm font-thin tracking-wide text-teal-
                           700 text-center">
                                BEANS COST PER PACK <br/>(MYR BY {{weightPerPack?
weightPerPack:0}}GRAM)
                        </div>
                        <div class="font-sans text-sm font-medium text-3xl tracking-wide 
                         -teal-600 text-center">
                ...
                <template v-slot:content>
                    <form class="flex grid grid-cols-1 md:grid-cols-4 ">
                        <div class="my-2 mx-2 relative md:col-span-2">
                            ...
                            @input="bean=$event"
                            :disabled="false"/>
                            <i class= "fas fa-globe-asia absolute top-0
                            text-gray-500 right-0 p-3"></i>
...
(this.selectedStock.price/this.selectedStock.purchasedStock))/this.calculatePack() : 0.0
            ...
            calculatePack: function(){
                let packs =
                parseInt(this.weightAfterRoast/(this.weightPerPack/1000))
                return packs
                },
